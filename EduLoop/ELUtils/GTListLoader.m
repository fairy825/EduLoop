...
//    NSString *urlString = @"https://static001.geekbang.org/univer/classes/ios_dev/lession/45/toutiao.json";
    NSString *urlString = [BasicInfo url:@"/task/teacher"];
...
#warning 注意类型的检查
                                          NSArray *dataArray =  [((NSDictionary *)[((NSDictionary *)jsonObj) objectForKey:@"data"]) objectForKey:@"rows"];
...
- (NSArray<GTListItem *> *)_readDataFromLocal{
    ...
    id unarchiveObj = [NSKeyedUnarchiver unarchivedObjectOfClasses:[NSSet setWithObjects:[NSArray class],[NSObject class], nil]  fromData:readListData error:nil];
